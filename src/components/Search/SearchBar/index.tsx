  ...
  return (
    <div className="flex w-full items-center justify-between">
      ...
      <input
        ...
        className="h-10 w-full rounded-l-lg border border-borderColor bg-lotion pl-9 text-base placeholder:text-textSecondary focus:border-borderFocus focus:outline-none focus:ring-0 dark:border-darkBorderColor dark:text-black"
